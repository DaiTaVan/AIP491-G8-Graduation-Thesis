...
with open('/media/tavandai/DATA7/fpt_university/Graduation_Thesis/AIP491-G8-Graduation-Thesis/dataset/Phapdien/root_nodes.json') as f1:
...
with open('/media/tavandai/DATA7/fpt_university/Graduation_Thesis/AIP491-G8-Graduation-Thesis/dataset/Phapdien/dieu_phap_dien.json') as f1:
    content = json.load(f1)

with open('/media/tavandai/DATA7/fpt_university/Graduation_Thesis/AIP491-G8-Graduation-Thesis/dataset/Phapdien/vbpl_title.json') as f1:
    vbpl_title = json.load(f1)

def add_child_nodes(listdieu):
...
def add_relationship_of_child_nodes(listdieu):
...
with ThreadPoolExecutor(max_workers=3) as executor:
    for ix, (demuc, listdieu) in enumerate(content.items()):
        executor.submit(add_relationship_of_child_nodes, listdieu)