...
def main(argv):
    ...
    funct_dict = {"3-6": jec_ac.compute_jec_ac,#flzx.compute_flzx, #jec_ac.compute_jec_ac,
                  "1-2": jec_kd.compute_jec_kd,
                  "3-2": cjft.compute_cjft,
                #   "3-8": flzx.compute_flzx,
                  "1-1": ftcs.compute_ftcs,
                  "2-2": jdzy.compute_jdzy,
                  "3-7": flzx.compute_flzx,#jetq.compute_jetq,
                ...
                #   "2-8": lblj.compute_lblj,
                  ...
                  "2-8": sjjc.compute_sjjc,
                  "2-9": sjjc.compute_cfcy}
