...
def main(args):
    ...
    model_id = "qnguyen3/14b-gguf"
    filename = "VinaLlama2-14B_Q8_0.gguf"

    # Ensure model is loaded onto the GPU
    # model = AutoModelForCausalLM.from_pretrained(model_id, gguf_file=filename, torch_dtype=torch.float16, device_map="auto")
